...
function clickListener(event){
    ...
    if (id0 === "x" && id1 === "x" && id2 === "x"){
        ...
        haveWinner=true
        player1Score += 1;
        document.querySelector('.player-x-score').innerHTML = player1Score;
        ...
        haveWinner=true
        player2Score += 1;
        document.querySelector('.player-o-score').innerHTML = player2Score;
...
document.querySelector('#winMessage').textContent = 'Press empty cell to play!'
